...
List<Pet> getPetList() {
  return <Pet>[
    ...
    Pet("American Rabbit", "California", "2.5", "Adoption", Category.OTHER,
        "assets/images/bunnies/bunny_1.jpg", true, true),
    Pet("Belgian Hare Rabbit", "New Jersey", "2.5", "Mating", Category.OTHER,
        "assets/images/bunnies/bunny_2.jpg", false, false),
    Pet("Blanc de Hotot", "Miami", "2.5", "Disappear", Category.OTHER,
        "assets/images/bunnies/bunny_3.jpg", false, false),
    Pet("Californian Rabbits", "Chicago", "2.5", "Disappear", Category.OTHER,
        "assets/images/bunnies/bunny_4.jpg", true, true),
    Pet("Checkered Giant Rabbit", "New York", "2.5", "Adoption", Category.OTHER,
        "assets/images/bunnies/bunny_5.jpg", true, false),
    Pet("Dutch Rabbit", "California", "2.5", "Adoption", Category.OTHER,
        "assets/images/bunnies/bunny_6.jpg", false, false),
    Pet("English Lop", "Miami", "2.5", "Mating", Category.OTHER,
        "assets/images/bunnies/bunny_7.jpg", true, false),
    Pet("English Spot", "California", "2.5", "Adoption", Category.OTHER,
