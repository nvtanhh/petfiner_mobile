...
import 'package:pet_finder/locationpiker/entities/entities.dart';
import 'package:pet_finder/locationpiker/entities/localization_item.dart';
import 'package:pet_finder/locationpiker/entities/location_result.dart';
import 'package:pet_finder/locationpiker/entities/near_by_place.dart';
import 'package:pet_finder/locationpiker/widgets/near_by_place_item.dart';
import 'package:pet_finder/locationpiker/widgets/search_input.dart';
import 'package:pet_finder/locationpiker/widgets/select_place_action.dart';
...
class PlacePickerState extends State<PlacePicker> {
  ...
  LatLng _currentLatLng = LatLng(10.873286, 106.7914436);
  ...
  void initState() {
    super.initState();
    markers.add(Marker(
      position: widget.displayLocation ?? _currentLatLng,
          ...
          Expanded(
            child: GoogleMap(
              ...
              onTap: (latLng) {
                ...
                print("PICKER" + _currentLatLng.toString());
                clearOverlay();
