...
class InboxBloc extends ChangeNotifier {
  ...
  Future<String> createGroup(String lastUser, DateTime time, String lastMessage,
      String image, List<String> users) async {
    DocumentReference docRef = await firestore.collection(groupCollection).add({
      'lastUser': lastUser,
  ...
  Future<List<FbInboxGroupModel>> getList20Inbox(String idUser) async {
    ...
    print('getList20Inbox' + groups.toString());
